...
public class StudentResourceIntTest {
    ...
    public void setup() {
        ...
        StudentResource studentResource = new StudentResource(studentRepository, studentMapper);
    ...
    public void createStudent() throws Exception {
        ...
        assertThat(testStudent.getIdentification()).isEqualTo(DEFAULT_IDENTIFICATION);
    ...
    public void updateStudent() throws Exception {
        ...
        assertThat(testStudent.getIdentification()).isEqualTo(UPDATED_IDENTIFICATION);
